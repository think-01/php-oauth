...
class FacebookTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetAuthorizationMethod()
	{
		...
		$service = $this->getMock('\\OAuth\\OAuth2\\Service\\Facebook', ['httpRequest'], [
			$this->getMock('\\OAuth\\Common\\Consumer\\CredentialsInterface'),
			$this->getMock('\\Buzz\\Browser'),
			$storage
		]);
	...
	public function testParseAccessTokenResponseValidWithoutRefreshToken()
	{
		...
		$service->expects($this->once())->method('httpRequest')->will($this->returnValue('access_token=foo&expires=bar'));
	...
	public function testParseAccessTokenResponseValidWithRefreshToken()
	{
		...
		$service->expects($this->once())->method('httpRequest')->will($this->returnValue('access_token=foo&expires=bar&refresh_token=baz'));
