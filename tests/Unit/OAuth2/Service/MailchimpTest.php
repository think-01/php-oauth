...
class MailchimpTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetAuthorizationMethod()
	{
		...
		$service = $this->getMock('\\OAuth\\OAuth2\\Service\\Mailchimp', ['httpRequest'], [
			$this->getMock('\\OAuth\\Common\\Consumer\\CredentialsInterface'),
			$this->getMock('\\Buzz\\Browser'),
			$storage,
			[],
	...
	public function testParseAccessTokenResponseValid()
	{
		...
		$service->expects($this->at(0))->method('httpRequest')->will($this->returnValue('{"access_token":"foo","expires_in":"bar"}'));
