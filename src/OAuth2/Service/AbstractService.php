...
abstract class AbstractService extends BaseAbstractService implements ServiceInterface {
	...
	)
	{
		...
		if ($this->baseApiUri) $this->injectApiVersionToUri($this->baseApiUri);
	}
	...
	{
		if (!$this->isRequestArgumentsPassed($request)) throw new Exception('Code has not passed to request arguments!');
